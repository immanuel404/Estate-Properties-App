<?php
	...
	$longitude = mysqli_real_escape_string($db, $_POST['longitude']);
 	...
 	$sql = " UPDATE location SET name = ?, info = ?, features = ?, email = ?, phone = ?, latitude = ?, longitude = ? WHERE id = '$id' ";
	...
	if (!mysqli_stmt_prepare($stmt, $sql)) {
		...
		mysqli_stmt_bind_param($stmt, "sssssss", $name, $info, $features, $email, $phone, $latitude, $longitude);
